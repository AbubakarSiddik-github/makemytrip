...
public class BookingController {
    ...
    @PostMapping("/cancel")
    public ResponseEntity<Users> cancelBooking(@RequestParam String userId, @RequestParam int index, @RequestParam String reason) {
        return ResponseEntity.ok(bookingService.cancelBooking(userId, index, reason));
    }
}
