...
const BookHotelPage = () => {
  ...
  const roomTotal = roomSurcharge * quantity;
  const grandTotal = totalPrice + totalTaxes - totalDiscounts + roomTotal;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              <div className="sm:col-span-2 relative group cursor-pointer">
                <img
            ...
            <div className="mb-8">
              <RoomGrid
                quantity={quantity}
                prefKey="roomPref"
                onChange={(room: string, surcharge: number) => {
                  setSelectedRoom(room);
                  setRoomSurcharge(surcharge);
                }}
              />
            </div>

            <Reviews itemId={hotel.id} itemType="hotel" />
          </div>
