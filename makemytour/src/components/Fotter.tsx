        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 md:mb-0">
              <a href="https://github.com/AbubakarSiddik-github" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/in/u-siddik-03b4762a6" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:usiddik331@gmail.com" className="hover:text-white">
                <Mail className="w-5 h-5" />
              </a>
              <a href="tel:+918309637682" className="hover:text-white">
                <Phone className="w-5 h-5" />
              </a>
            </div>
            <p className="text-sm">
              © 2026 URAVAKONDA ABUBAKAR SIDDIK. All rights reserved
            </p>
          </div>
        </div>
      </div>
